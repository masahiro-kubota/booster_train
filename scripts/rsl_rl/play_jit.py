...
"""Script to play an exported TorchScript policy in Isaac Lab."""
...
parser = argparse.ArgumentParser(description="Play an exported TorchScript policy in Isaac Lab.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    """Play an exported TorchScript policy."""
    ...
    if args_cli.video:
        video_kwargs = {
            "video_folder": os.path.join(log_dir, "videos", "play_jit"),
