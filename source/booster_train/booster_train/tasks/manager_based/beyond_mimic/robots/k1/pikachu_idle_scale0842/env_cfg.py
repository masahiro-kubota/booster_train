...
class FlatEnvCfg(TrackingEnvCfg):
    def __post_init__(self):
        ...
        self.commands.motion.motion_file = f"{BOOSTER_ASSETS_DIR}/motions/K1/k1_pikachu_idle_scale0842_pingpong_tile3_blender50_grounded_hold0p5.npz"
        self.commands.motion.tail_len = 615
